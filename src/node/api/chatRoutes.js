...
// EXACT old logic from your old chatRoutes.js
router.post('/chat', authenticate, async (req, res) => {
    ...
    if (bestMatch.score >= 0.5) {
        console.log("Match found in FAQ:", bestMatch.faq.question);
        res.json({ reply: bestMatch.faq.answer, source: 'FAQ' });
    } else {
        console.log("No good FAQ match, fallback to Rasa");
        // If no FAQ matches, send the query to Rasa
        try {
