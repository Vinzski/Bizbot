(function () {
    ...
    function initializeChatbot() {
        ...
        // const userId = widgetElement.getAttribute('data-user-id'); // Not needed if userId is from token
        const initialToken = widgetElement.getAttribute('data-token');

        console.log('Initializing Chatbot Widget:');
        console.log(`chatbotId: ${chatbotId}`);
        // console.log(`userId: ${userId}`); // Not needed
        ...
        fetch('https://bizbot-khpq.onrender.com/api/token', {
            ...
            body: JSON.stringify({ chatbotId, /* userId */ }) // Remove userId if not needed
        })
        .then(response => {
            if (!response.ok) {
    ...
    function sendMessage(userInput) {
        const widgetElement = document.getElementById('bizbot-widget');
        const chatbotId = widgetElement.getAttribute('data-chatbot-id');
        // const userId = widgetElement.getAttribute('data-user-id'); // Not needed
