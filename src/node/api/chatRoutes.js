...
const authenticateByDomain = (req, res, next) => {
    const allowedDomains = ['http://localhost:8080/', 'http://localhost:8080/index.html', 'https://bizbot-khpq.onrender.com/dashboard.html', 'http://localhost/EnE_Portal_Final/login.php'];
...
router.post('/chat', authenticateByDomain, authenticate, async (req, res) => {
